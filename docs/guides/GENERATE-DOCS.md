...
- `docs/guides/target/generated-docs/<operator|server|getting-started|admin-api|observability|high-availability|securing-apps|ui-customization>/index.html`: all guides in a single html file generated with asciidoc maven plugins. 
