...
* `.bcfks` for a BCFKS file

If your keystore does not have one of these extensions, you must set the `https-key-store-type` option. Similarly, `.truststore` is recognized for trust stores.
