...
public class KcAdmV2HelpTest {
    ...
    public void testOutputOptionsNotAvailableOnDelete() {
        ...
        assertFalse("delete (204 No Content) should not have --fields", help.contains("--fields"));
        assertFalse("delete (204 No Content) should not have --format", help.contains("--format"));
        assertFalse("delete (204 No Content) should not have --noquotes", help.contains("--noquotes"));
