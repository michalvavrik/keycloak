...
public class KcAdmV2HelpTest {
    ...
    @Test
    public void testCompressedOptionAvailableOnSubcommand() {
        String help = getSubcommandHelp("client", "list");
        assertTrue("list should have -c option", help.contains("-c"));
        assertTrue("list should have --compressed option", help.contains("--compressed"));
    }

    @Test
    public void testCompressedOptionAvailableOnVariant() {
        String help = getVariantHelp("create", "oidc");
        assertTrue("create oidc should have -c option", help.contains("-c"));
    }
