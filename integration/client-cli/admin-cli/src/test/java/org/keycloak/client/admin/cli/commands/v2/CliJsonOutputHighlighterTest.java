...
import static org.keycloak.client.admin.cli.v2.CliJsonOutputHighlighter.ARRAY_DEPTH_CYCLE;
...
import static org.keycloak.client.admin.cli.v2.CliJsonOutputHighlighter.OBJECT_DEPTH_CYCLE;
...
public class CliJsonOutputHighlighterTest {
    ...
    public void testStringValues() {
        ...
        String result = CliJsonOutputHighlighter.highlight(json, false);
    ...
    @Test
    public void testObjectPunctuation() {
        String json = "{\"a\":1,\"b\":2}";
        String result = CliJsonOutputHighlighter.highlight(json, false);
    ...
    @Test
    public void testNestedObjectsHaveDifferentColors() {
        int depth = OBJECT_DEPTH_CYCLE + 1;
    ...
    @Test
    public void testNestedArraysHaveDifferentColors() {
        int depth = ARRAY_DEPTH_CYCLE + 1;
    ...
    public void testPrettyPrintedOutput() {
        String result = CliJsonOutputHighlighter.highlight("{\"name\":\"Alice\",\"age\":30}", false);
    ...
    public void testCompressedOutput() {
        String result = CliJsonOutputHighlighter.highlight("{\"name\":\"Alice\",\"age\":30}", true);
    ...
    @Test
    public void testCompressedPreservesJsonStructure() {
        String json = "{\"name\":\"Alice\",\"age\":30,\"active\":true}";
        String result = CliJsonOutputHighlighter.highlight(json, true);

        assertEquals("Stripped output should be valid compressed JSON", json, stripAnsiCodes(result));
    }

    @Test
    public void testPrettyPrintPreservesJsonContent() {
    ...
    @Test
    public void testStringWithJsonEscapeSequences() {
    ...
    public void testOutputEndsWithReset() {
        String result = CliJsonOutputHighlighter.highlight("{\"a\":1}", false);
