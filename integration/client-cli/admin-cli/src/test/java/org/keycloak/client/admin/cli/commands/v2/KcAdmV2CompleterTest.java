...
public class KcAdmV2CompleterTest {
    ...
    public void testOutputOptionsNotInAutocompleteForDelete() {
        ...
        assertFalse("delete should not suggest '--fields'", candidates.contains("--fields"));
        assertFalse("delete should not suggest '--format'", candidates.contains("--format"));
        assertFalse("delete should not suggest '--noquotes'", candidates.contains("--noquotes"));
    }
