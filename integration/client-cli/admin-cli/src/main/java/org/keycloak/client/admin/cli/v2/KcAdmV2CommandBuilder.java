...
class KcAdmV2CommandBuilder {
    ...
    static final String OPT_NO_CONFIG = "--no-config";
    ...
    static final String OPT_STOREPASS = "--storepass";
    static final String OPT_KEYPASS = "--keypass";
    ...
    private static void addConnectionGroup(CommandSpec spec) {
        spec.addArgGroup(ArgGroupSpec.builder()
                ...
                .addArg(OptionSpec.builder(OPT_CONFIG)
                        ...
                        .build())
                .addArg(OptionSpec.builder(OPT_NO_CONFIG)
                        .type(boolean.class)
                        .description("Don't use config file - no authentication info is loaded or saved")
                        .build())
                ...
                .addArg(OptionSpec.builder(OPT_TOKEN)
                        ...
                        .build())
                .addArg(OptionSpec.builder(OPT_KEYSTORE)
                        .type(String.class)
                        .paramLabel("<path>")
                        .description("Path to a keystore containing private key for client certificate auth")
                        .build())
                .addArg(OptionSpec.builder(OPT_STOREPASS)
                        .type(String.class)
                        .paramLabel("<password>")
                        .description("Keystore password (prompted if not specified and KC_CLI_STORE_PASSWORD is not set)")
                        .build())
                .addArg(OptionSpec.builder(OPT_KEYPASS)
                        .type(String.class)
                        .paramLabel("<password>")
                        .description("Key password (defaults to keystore password if not specified)")
                        .build())
                .addArg(OptionSpec.builder(OPT_ALIAS)
                        .type(String.class)
                        .paramLabel("<alias>")
                        .description("Alias of the key inside a keystore (defaults to the value of " + OPT_CLIENT + ")")
                        .build())
