...
public class KcAdmV2ClientCLITest {
    ...
    void testCreateClientValidationError() {
        CommandResult result = kcAdmV2Cmd("client", "create", "--protocol", "openid-connect");
    ...
    void testListClients() {
        kcAdmV2Cmd("client", "create", "--client-id", "test-for-list-1", "--protocol", "openid-connect");
        kcAdmV2Cmd("client", "create", "--client-id", "test-for-list-2", "--protocol", "openid-connect");
    ...
    void testPatchClient() {
        CommandResult createResult = kcAdmV2Cmd("client", "create", "--client-id", "test-for-patch",
        ...
        CommandResult patchResult = kcAdmV2Cmd("client", "patch", id, "--enabled", "false");
