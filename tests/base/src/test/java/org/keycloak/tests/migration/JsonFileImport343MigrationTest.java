...
public class JsonFileImport343MigrationTest extends AbstractJsonFileImportMigrationTest {
    ...
    @InjectRealm(ref = "migration", fromJson = "migration-realm-3.4.3.Final-Migration.json")
    ManagedRealm migrationManagedRealm;

    @InjectRealm(ref = "migration2", fromJson = "migration-realm-3.4.3.Final-Migration2.json")
